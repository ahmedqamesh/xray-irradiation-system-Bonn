...
#
    ...
    def plot_beamspot(self, filename =False,PdfPages=False):
        self.log.info('plot the beamspot')
...
class Attenuation(object):
    ...
    def mass_attenuation_coeff(self, Directory=False, PdfPages=False, targets=False):
        for target in targets:
            fig = plt.figure()
            ax = fig.add_subplot(111)
            print(Directory + target + "/mass_attenuation_coeff_in_detail_" + target + ".dat")
