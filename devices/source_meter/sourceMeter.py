...
class SourceMeter(HardwareLayer):
    ...
    def IV_test(self, directory = None, currentLimit=1.000000E-01, start_V=None, step_V=None, end_V=None,
                Itterations=None, stat_delay=None, Plot=None, diodes=[0]):
        ...
        if Plot:
            self.plot_IV_test(directory=directory,diodes=diodes)
 
    def plot_IV_test(self, directory=False,diodes=[0]):
        fig = plt.figure()
        fig.add_subplot(111)
        ax = plt.gca()
        conversion = 10**9
