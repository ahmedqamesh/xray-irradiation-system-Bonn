...
class MainWindow(QMainWindow):
    ...
    def doseCalculatorWindow(self):
        ...
        self.fig = DataMonitoring.BeamMonitoring() #BeamMonitoring()
    ...
    def update_plot(self):
        ...
        dD = f.dose_depth(depth = h, filter = "without_Al_filter", current ="50mA",voltage = "40kV")
