...
def get_Secondary_spectrum( Directory=False, PdfPages=False, test=False, hist_id=[0], location=False, colors=False, table=False, style="-",
...
def Energy_deposition( Directory=False, PdfPages=False, hist_id=[0], test=False, labels=False, style='-', location=False, colors=False,
...
def Metal_layers(Directory=False, PdfPages=False, test=False, hist_id=[0], location=False, save=True, colors=False, xmax=False, xmin=False,
    ...
    total_thickness = Rd53_metal_layers(Directory=Directory, location=location, ax2=ax2)
...
if __name__ == '__main__':
    ...
    global PdfPages
    Directory = "Geant4_simulation_results/"
    pdf_file = 'output_data/SimulationCurve_Bonn' + '.pdf'
...
# Diode spectra
    ...
    Secondary_electrons = get_Secondary_spectrum(Directory=Directory, PdfPages=PdfPages, test=["RD53"], table=True,xmin=0.0, xmax=60,style="-",
